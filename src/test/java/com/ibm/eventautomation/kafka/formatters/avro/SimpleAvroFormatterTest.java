...
public class SimpleAvroFormatterTest extends AvroFormatterTest {

    private static final String SEPARATOR = "\n**********\n";

    public SimpleAvroFormatterTest() throws IOException {
        super();
    }
    ...
    public String getExpectedFormattedOutput()
    {
        return
            "{" +
                "\"id\": \"4efb1831-d7fc-4665-8ff8-bce4e777b37f\", " +
                "\"name\": \"Test Item\", " +
                "\"price\": 47.99, " +
                "\"quantity\": 2" +
            "}";
