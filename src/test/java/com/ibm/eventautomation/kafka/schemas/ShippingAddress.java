...
public class ShippingAddress extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageEncoder<ShippingAddress> getEncoder() {
    return ENCODER;
  }
   ...
   * @return a ShippingAddress instance decoded from the given buffer
  ...
  /** House number for the shipping address */
  private java.lang.Integer number;
  /** Street for the shipping address */
  private java.lang.CharSequence street;
  /** City for the shipping address */
  private java.lang.CharSequence city;
  /** Zipcode for the shipping address */
  private java.lang.CharSequence zipcode;
  /** Country for the shipping address */
  private com.ibm.eventautomation.kafka.schemas.ShippingCountry country;
  /** Phone numbers for the shipping address */
   ...
   * @param number House number for the shipping address
   * @param street Street for the shipping address
   * @param city City for the shipping address
   * @param zipcode Zipcode for the shipping address
   * @param country Country for the shipping address
   * @param phones Phone numbers for the shipping address
   */
  public ShippingAddress(java.lang.Integer number, java.lang.CharSequence street, java.lang.CharSequence city, java.lang.CharSequence zipcode, com.ibm.eventautomation.kafka.schemas.ShippingCountry country, java.util.List<java.lang.CharSequence> phones) {
    this.number = number;
    this.street = street;
    this.city = city;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 4: country = (com.ibm.eventautomation.kafka.schemas.ShippingCountry)value$; break;
   ...
   * @return House number for the shipping address
   */
   ...
   * @return Street for the shipping address
   */
   ...
   * @return City for the shipping address
   */
   ...
   * @return Zipcode for the shipping address
   */
   ...
   * @return Country for the shipping address
   */
  public com.ibm.eventautomation.kafka.schemas.ShippingCountry getCountry() {
    return country;
  }
   ...
   * @param value the value to set.
   */
  public void setCountry(com.ibm.eventautomation.kafka.schemas.ShippingCountry value) {
    this.country = value;
  }

  /**
   * Gets the value of the 'phones' field.
   * @return Phone numbers for the shipping address
   */
   ...
   */
  public static com.ibm.eventautomation.kafka.schemas.ShippingAddress.Builder newBuilder() {
    return new com.ibm.eventautomation.kafka.schemas.ShippingAddress.Builder();
  }
   ...
   * @return A new ShippingAddress RecordBuilder
   */
  public static com.ibm.eventautomation.kafka.schemas.ShippingAddress.Builder newBuilder(com.ibm.eventautomation.kafka.schemas.ShippingAddress.Builder other) {
    if (other == null) {
      return new com.ibm.eventautomation.kafka.schemas.ShippingAddress.Builder();
    } else {
      return new com.ibm.eventautomation.kafka.schemas.ShippingAddress.Builder(other);
    }
  }
   ...
   * @return A new ShippingAddress RecordBuilder
   */
  public static com.ibm.eventautomation.kafka.schemas.ShippingAddress.Builder newBuilder(com.ibm.eventautomation.kafka.schemas.ShippingAddress other) {
    if (other == null) {
      return new com.ibm.eventautomation.kafka.schemas.ShippingAddress.Builder();
    } else {
      return new com.ibm.eventautomation.kafka.schemas.ShippingAddress.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ShippingAddress>
    ...
    /** Country for the shipping address */
    private com.ibm.eventautomation.kafka.schemas.ShippingCountry country;
    private com.ibm.eventautomation.kafka.schemas.ShippingCountry.Builder countryBuilder;
    /** Phone numbers for the shipping address */
    private java.util.List<java.lang.CharSequence> phones;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ibm.eventautomation.kafka.schemas.ShippingAddress.Builder other) {
      super(other);
      ...
      if (other.hasCountryBuilder()) {
        this.countryBuilder = com.ibm.eventautomation.kafka.schemas.ShippingCountry.newBuilder(other.getCountryBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ibm.eventautomation.kafka.schemas.ShippingAddress other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.number)) {
        this.number = data().deepCopy(fields()[0].schema(), other.number);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ibm.eventautomation.kafka.schemas.ShippingAddress.Builder setNumber(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ibm.eventautomation.kafka.schemas.ShippingAddress.Builder clearNumber() {
      number = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ibm.eventautomation.kafka.schemas.ShippingAddress.Builder setStreet(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ibm.eventautomation.kafka.schemas.ShippingAddress.Builder clearStreet() {
      street = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ibm.eventautomation.kafka.schemas.ShippingAddress.Builder setCity(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ibm.eventautomation.kafka.schemas.ShippingAddress.Builder clearCity() {
      city = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ibm.eventautomation.kafka.schemas.ShippingAddress.Builder setZipcode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ibm.eventautomation.kafka.schemas.ShippingAddress.Builder clearZipcode() {
      zipcode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ibm.eventautomation.kafka.schemas.ShippingAddress.Builder setCountry(com.ibm.eventautomation.kafka.schemas.ShippingCountry value) {
     ...
     * @return This builder.
     */
    public com.ibm.eventautomation.kafka.schemas.ShippingCountry.Builder getCountryBuilder() {
      if (countryBuilder == null) {
        if (hasCountry()) {
          setCountryBuilder(com.ibm.eventautomation.kafka.schemas.ShippingCountry.newBuilder(country));
        } else {
          setCountryBuilder(com.ibm.eventautomation.kafka.schemas.ShippingCountry.newBuilder());
        }
      }
    ...
    public com.ibm.eventautomation.kafka.schemas.ShippingAddress.Builder setCountryBuilder(com.ibm.eventautomation.kafka.schemas.ShippingCountry.Builder value) {
      clearCountry();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ibm.eventautomation.kafka.schemas.ShippingAddress.Builder clearCountry() {
      country = null;
      countryBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ibm.eventautomation.kafka.schemas.ShippingAddress.Builder setPhones(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ibm.eventautomation.kafka.schemas.ShippingAddress.Builder clearPhones() {
      phones = null;
    ...
    public ShippingAddress build() {
      try {
        ...
        if (countryBuilder != null) {
          ...
          record.country = fieldSetFlags()[4] ? this.country : (com.ibm.eventautomation.kafka.schemas.ShippingCountry) defaultValue(fields()[4]);
        }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (this.country == null) {
        this.country = new com.ibm.eventautomation.kafka.schemas.ShippingCountry();
      }
